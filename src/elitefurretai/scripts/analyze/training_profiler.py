...
from elitefurretai.model_utils import OptimizedBattleDataLoader, MDBO, Embedder, flatten_and_filter, topk_cross_entropy_loss, load_compressed
from torch.utils.data import Dataset, DataLoader


# Sample Model Definition for training
