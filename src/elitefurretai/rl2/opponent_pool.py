...
class ExploiterRegistry:
    ...
    def add_exploiter(self, exploiter_info: Dict[str, Any]):
        ...
        if "id" not in exploiter_info:
            ...
            raise ValueError(f"Exploiter with filepath {exploiter_info['filepath']} already exists.")
...
class OpponentPool:
    ...
    def __init__(
        ...
        self.loaded_exploiters: Dict[str, RNaDAgent] = {}  # Cache: exploiter_id -> RNaDAgent
    ...
    def sample_opponent(self, player_config: AccountConfiguration, server_config: ServerConfiguration, team: str) -> Player:
        """
    ...
    def _create_self_play_opponent(self, player_config: AccountConfiguration, server_config: ServerConfiguration, team: str) -> Player:
    ...
    def _create_exploiter_opponent(self, player_config: AccountConfiguration, server_config: ServerConfiguration, team: str) -> Player:
        ...
        exploiter_team = exploiter_info.get('team', team)  # Fallback to provided team if not found
