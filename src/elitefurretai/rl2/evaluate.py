...
from poke_env.player import Player, PlayerConfiguration, ServerConfiguration
...
async def run_evaluation(
    ...
    player1 = BatchInferencePlayer(
        ...
        device=device,
        batch_size=16,
        player_configuration=PlayerConfiguration("Model1", None),
    ...
    player2 = BatchInferencePlayer(
        ...
        device=device,
        batch_size=16,
        player_configuration=PlayerConfiguration("Model2", None),
        server_configuration=server_config,
        battle_format="gen9vgc2023regulationc",
        probabilistic=False
    )
...
def main():
    ...
    server_config = ServerConfiguration(args.server, None)
