...
from poke_env.player import PlayerConfiguration, ServerConfiguration
...
class TrainingProfiler:
    ...
    def profile_training(
        ...
        return {
            ...
            'min_ms': np.min(times),
            'max_ms': np.max(times),
            'updates_per_hour': 3600 / (np.mean(times) / 1000)
        }
    ...
    def profile_configuration(
        ...
        Args:
            ...
            profile_duration: How long to profile (seconds)
    ...
    def profile_sweep(
        self,
        worker_configs: List[Tuple[int, int]] = None,
        batch_configs: List[Tuple[int, int]] = None,
...
def main():
    ...
    parser.add_argument("--model", type=str, default="data/models/bc_action_model.pt",
