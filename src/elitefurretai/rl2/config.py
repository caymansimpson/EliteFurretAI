...
class RNaDConfig:
    ...
    # Team configuration
    team_pool_path: Optional[str] = "data/teams/gen9vgc2023regulationc"  # Directory with team files
    ...
    exploiter_interval: int = 10000  # Train exploiter every N updates
    exploiter_updates: int = 50000  # Number of updates for exploiter training
    exploiter_min_win_rate: float = 0.55  # Minimum win rate to add exploiter
    exploiter_lr: float = 1e-4
    exploiter_ent_coef: float = 0.02  # Higher entropy for exploration
    
    # Hardware configuration
    device: str = "cuda"
    num_showdown_servers: int = 4
